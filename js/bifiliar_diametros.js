...
function calcular_dimensiones(){
        ...
        document.getElementById("bif_distancia").style.display="none";
        document.getElementById("bif_espacio").style.display="none";
        document.getElementById("resultadoespacio").style.display="none";
        document.getElementById("resultadodcc").style.display="none";
