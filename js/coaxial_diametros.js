...
function calcular_dimensiones(){
        document.getElementById("coax_diame").style.display="none";
        document.getElementById("coax_diami").style.display="none";
        document.getElementById("resultadodiame").style.display="none";
        document.getElementById("resultadodiami").style.display="none";
        ...
        document.getElementById("coax_diame").style.display="block";
        document.getElementById("coax_diami").style.display="block";
        document.getElementById("resultadodiame").style.display="block";
        document.getElementById("resultadodiami").style.display="block";
